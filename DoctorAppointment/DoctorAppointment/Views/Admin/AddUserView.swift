        ...
        NavigationView {
            VStack{
                ...
                Button("Add doctor") {
                    ...
                    let doctor = Doctor(firstName: firstName, middleName: middleName, lastName: lastName, phoneNumber: "", email: email, profession: "", about: "", clinicId: getClinicIdForClinicName(name: selectedClinic) , isActive: false, profilePicture: nil, isEnabled: false)
